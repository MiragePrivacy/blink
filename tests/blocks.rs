...
use blink::blocks::{block_number_at_time, block_timestamp, replace_runtime_checkpoints};
use blink::chains::{ETHEREUM_CHAIN_ID, GNOSIS_CHAIN_ID};
use chrono::{Datelike, TimeZone};

fn install_checkpoints() {
    static INSTALL: Once = Once::new();
    INSTALL.call_once(|| {
        replace_runtime_checkpoints(HashMap::from([
            (
                ETHEREUM_CHAIN_ID,
                vec![(24_000_000, 1_765_584_371), (25_497_188, 1_783_626_143)],
            ),
            (
                GNOSIS_CHAIN_ID,
                vec![(46_762_380, 1_781_798_438), (47_119_233, 1_783_626_150)],
            ),
        ]));
    });
}
